...
conn = sqlite3.connect("restaurant_paris.db")
...
map_paris.save("templates/paris_restaurant_satisfaction_map.html")

print("Carte interactive sauvegardée sous paris_restaurant_satisfaction_map.html")
